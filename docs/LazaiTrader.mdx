...
5. **Share & Learn**: Contribute to the Strategy Vault and get AI-powered suggestions
...
**Q: How do I monitor my performance?**
A: Use `/chart` to view your trading performance, check `/balance`, and watch your "Total USD" value to track your progress.
...
A: Withdrawals will be enabled when the project moves to Hyperion mainnet.
...
9. **Ask our support Alith agent**: https://t.me/LazaiTrader_alithbot

Remember: This is both a learning experience and opportunity to test automated trading strategies. Use the Strategy Vault to improve your approach, test different pairs, and help build the collective knowledge base.

Happy trading! 🚀

---
*LazaiTrader is built by gMetis using the Alith AI framework on Hyperion testnet.*
