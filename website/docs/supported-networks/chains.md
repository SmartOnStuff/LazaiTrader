...
Check our [Roadmap](../roadmap/cross-chain-expansion) for the latest plans. We prioritize chains based on:
- User demand
- DEX availability
- Gas economics
...
- [Tokens](tokens) - Supported tokens per chain
- [Trading Pairs](trading-pairs) - Available pairs
- [Cross-Chain Expansion](../roadmap/cross-chain-expansion) - Future plans
