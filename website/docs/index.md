...
1. **Start the Bot** - Send `/start` to [@lazaitrader\_bot](https://t.me/LazaiTrader_Bot) on Telegram
...
Ready to automate your trading? Head to the [Getting Started](introduction/getting-started) guide.

***

## Support

* Telegram: [@lazaitrader\_bot](https://t.me/lazaitrader_bot)
